...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `C:/Users/QUANGMINH/Desktop/CONGDOAN/.claude/.gsd-surface.json`
(sibling to `C:/Users/QUANGMINH/Desktop/CONGDOAN/.claude/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `C:/Users/QUANGMINH/Desktop/CONGDOAN/.claude/skills/gsd-*/`.
...
(`~/.claude`), NOT the skills sub-directory (`C:/Users/QUANGMINH/Desktop/CONGDOAN/.claude/skills`).
...
`C:/Users/QUANGMINH/Desktop/CONGDOAN/.claude/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `C:/Users/QUANGMINH/Desktop/CONGDOAN/.claude/.gsd-surface.json`).
...
<execution_context>
Surface state file: `C:/Users/QUANGMINH/Desktop/CONGDOAN/.claude/.gsd-surface.json`
Install profile marker: `C:/Users/QUANGMINH/Desktop/CONGDOAN/.claude/.gsd-profile`
Skill dirs: `C:/Users/QUANGMINH/Desktop/CONGDOAN/.claude/skills/gsd-*/`
Engine module: `C:/Users/QUANGMINH/Desktop/CONGDOAN/.claude/gsd-core/bin/lib/surface.cjs`
Cluster definitions: `C:/Users/QUANGMINH/Desktop/CONGDOAN/.claude/gsd-core/bin/lib/clusters.cjs`
</execution_context>
