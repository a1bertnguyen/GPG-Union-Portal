...
**Verification depth scales with `asvs_level`** (see @C:/Users/QUANGMINH/Desktop/CONGDOAN/.claude/gsd-core/references/security-asvs-levels.md for full definitions):
