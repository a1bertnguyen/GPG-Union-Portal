...
```
Agent(
  prompt="Read C:/Users/QUANGMINH/Desktop/CONGDOAN/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `C:/Users/QUANGMINH/Desktop/CONGDOAN/.claude/gsd-core/templates/SECURITY.md`
