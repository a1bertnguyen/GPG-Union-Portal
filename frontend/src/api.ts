...
const fallbackLabels: Record<string, string> = {
  ...
  UNION: 'Công đoàn hỗ trợ', COMPANY: 'Công ty hỗ trợ',
  ...
  PLANNED: 'Kế hoạch', APPROVED: 'Đã duyệt', INCOME: 'Thu', EXPENSE: 'Chi', ADVANCE: 'Tạm ứng',
  ...
  SUPPORTING_DOCUMENT: 'Hồ sơ / chứng từ', RECEIPT: 'Biên nhận / quyết toán', IMAGE: 'Hình ảnh',
