...
export default function App() {
  ...
  const [active, setActive] = useState<PageKey>(() => getSession()?.user.role === 'ADMIN' ? 'dashboard' : 'home')
  ...
  if (!session) return <LoginPage onLogin={nextSession => { setSession(nextSession); setActive(nextSession.user.role === 'ADMIN' ? 'dashboard' : 'home') }} />
