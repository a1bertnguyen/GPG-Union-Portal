...
**Verification depth scales with `asvs_level`** (see @C:/Users/QUANGMINH/Desktop/CONGDOAN/.codex/gsd-core/references/security-asvs-levels.md for full definitions):
